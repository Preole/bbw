 ...
 * Build: `lodash compat category="collections,objects" exports="global" include="difference,uniq,union"`
 */
...
[]}function oa(){return qa.pop()||{k:null,l:null,m:null,"false":false,n:0,"null":false,number:null,object:null,push:null,string:null,"true":false,undefined:false,o:null}}function ca(a){return typeof a.toString!="function"&&typeof(a+"")=="string"}function D(a){a.length=0;pa.length<La&&pa.push(a)}function da(a){var b=a.l;b&&da(b);a.k=a.l=a.m=a.object=a.number=a.string=a.o=null;qa.length<La&&qa.push(a)}function x(a,b,c){b||(b=0);typeof c=="undefined"&&(c=a?a.length:0);var d=-1;c=c-b||0;for(var f=Array(0>c?0:c);++d<
c;)f[d]=a[b+d];return f}function e(){}function pb(a){function b(){if(d){var a=x(d);ea.apply(a,arguments)}if(this instanceof b){var h=ba(c.prototype),a=c.apply(h,a||arguments);return y(a)?a:h}return c.apply(f,a||arguments)}var c=a[0],d=a[2],f=a[4];ra(b,a);return b}function sa(a,b,c,d,f){if(c){var g=c(a);if(typeof g!="undefined")return g}if(y(a)){var h=r.call(a);if(!E[h]||!n.nodeClass&&ca(a))return a;var e=F[h];switch(h){case O:case P:return new e(+a);case Q:case K:return new e(a);case R:return g=e(a.source,
qb.exec(a)),g.lastIndex=a.lastIndex,g}}else return a;h=s(a);if(b){var q=!d;d||(d=J());f||(f=J());for(var p=d.length;p--;)if(d[p]==a)return f[p];g=h?e(a.length):{}}else g=h?x(a):fa({},a);h&&(t.call(a,"index")&&(g.index=a.index),t.call(a,"input")&&(g.input=a.input));if(!b)return g;d.push(a);f.push(g);(h?u:L)(a,function(a,h){g[h]=sa(a,b,c,d,f)});q&&(D(d),D(f));return g}function ba(a){return y(a)?ga(a):{}}function G(a,b,c){if(typeof a!="function")return ta;if(typeof b=="undefined"||!("prototype"in a))return a;
var d=a.__bindData__;if(typeof d=="undefined"&&(n.funcNames&&(d=!a.name),d=d||!n.funcDecomp,!d)){var f=rb.call(a);n.funcNames||(d=!sb.test(f));d||(d=Ma.test(f),ra(a,d))}if(false===d||true!==d&&d[1]&1)return a;switch(c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,f){return a.call(b,c,d,f)};case 4:return function(c,d,f,e){return a.call(b,c,d,f,e)}}return Na(a,b)}function Oa(a){function b(){var a=q?e:this;if(f){var r=x(f);ea.apply(r,
arguments)}if(g||l)if(r||(r=x(arguments)),g&&ea.apply(r,g),l&&r.length<m)return d|=16,Oa([c,n?d:d&-4,r,null,e,m]);r||(r=arguments);p&&(c=a[s]);return this instanceof b?(a=ba(c.prototype),r=c.apply(a,r),y(r)?r:a):c.apply(a,r)}var c=a[0],d=a[1],f=a[2],g=a[3],e=a[4],m=a[5],q=d&1,p=d&2,l=d&4,n=d&8,s=c;ra(b,a);return b}function Pa(a,b){var c=-1,d=ua(),f=a?a.length:0,g=f>=Qa&&d===aa,e=[];if(g){var m=Ka(b);m?(d=Ha,b=m):g=false}for(;++c<f;)m=a[c],0>d(b,m)&&e.push(m);g&&da(b);return e}function S(a,b,c,d){d=(d||
0)-1;for(var f=a?a.length:0,g=[];++d<f;){var e=a[d];if(e&&typeof e=="object"&&typeof e.length=="number"&&(s(e)||z(e))){b||(e=S(e,b,c));var m=-1,q=e.length,p=g.length;for(g.length+=q;++m<q;)g[p++]=e[m]}else c||g.push(e)}return g}function T(a,b,c,d,f,g){if(c){var e=c(a,b);if(typeof e!="undefined")return!!e}if(a===b)return 0!==a||1/a==1/b;if(a===a&&!(a&&M[typeof a]||b&&M[typeof b]))return false;if(null==a||null==b)return a===b;var m=r.call(a),q=r.call(b);m==U&&(m=A);q==U&&(q=A);if(m!=q)return false;switch(m){case O:case P:return+a==
+b;case Q:return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case R:case K:return a==String(b)}q=m==V;if(!q){var p=t.call(a,"__wrapped__"),l=t.call(b,"__wrapped__");if(p||l)return T(p?a.__wrapped__:a,l?b.__wrapped__:b,c,d,f,g);if(m!=A||!n.nodeClass&&(ca(a)||ca(b)))return false;m=!n.argsObject&&z(a)?Object:a.constructor;p=!n.argsObject&&z(b)?Object:b.constructor;if(m!=p&&!(H(m)&&m instanceof m&&H(p)&&p instanceof p)&&"constructor"in a&&"constructor"in b)return false}m=!f;f||(f=J());g||(g=J());for(p=f.length;p--;)if(f[p]==
...
b){l=f[p];break}if(!m){var n;c&&(p=c(l,b),n=typeof p!="undefined")&&(l=p);n||(l=q?s(l)?l:[]:va(l)?l:{});d.push(b);f.push(l);n||Ra(l,b,c,d,f)}}else c&&(p=c(l,b),typeof p=="undefined"&&(p=b)),typeof p!="undefined"&&(l=p);a[e]=l})}function Sa(a,b,c){var d=-1,f=ua(),e=a?a.length:0,h=[],m=!b&&e>=Qa&&f===aa,q=c||m?J():h;m&&(q=Ka(q),f=Ha);for(;++d<e;){var p=a[d],l=c?c(p,d,a):p;if(b?!d||q[q.length-1]!==l:0>f(q,l))(c||m)&&q.push(l),h.push(p)}m?(D(q.k),da(q)):c&&D(q);return h}function wa(a){return function(b,
c,d){var f={};c=e.createCallback(c,d,3);if(s(b)){d=-1;for(var g=b.length;++d<g;){var h=b[d];a(f,h,c(h,d,b),b)}}else u(b,function(b,d,e){a(f,b,c(b,d,e),e)});return f}}function xa(a,b,c,d,f,e){var h=b&1,m=b&4,q=b&16,p=b&32;if(!(b&2||H(a)))throw new TypeError;q&&!c.length&&(b&=-17,q=c=false);p&&!d.length&&(b&=-33,p=d=false);var l=a&&a.__bindData__;return l&&true!==l?(l=x(l),l[2]&&(l[2]=x(l[2])),l[3]&&(l[3]=x(l[3])),!h||l[1]&1||(l[4]=f),!h&&l[1]&1&&(b|=8),!m||l[1]&4||(l[5]=e),q&&ea.apply(l[2]||(l[2]=[]),c),p&&
...
";",f.length&&(d+="}"),d+="}",n.nonEnumShadows){d+="if(t!==A){var i=t.constructor,r=t===(i&&i.prototype),f=t===J?I:t===k?j:L.call(t),x=y[f];";for(k=0;7>k;k++)d+="n='"+c.h[k]+"';if((!(r&&x[n])&&m.call(t,n))",c.j||(d+="||(!x[n]&&t[n]!==A[n])"),d+="){"+c.g+"}";d+="}"}if(c.b||n.nonEnumArgs)d+="}";d+=c.c+";return E";return a("d,j,k,m,o,p,q,s,v,A,B,y,I,J,L",b+d+"}")(G,Ta,za,t,ub,z,s,I,w.f,ha,M,v,K,vb,r)}function ua(){var a=(a=e.indexOf)===Ua?aa:a;return a}function N(a){return typeof a=="function"&&wb.test(a)}
function Va(a){var b,c;if(!a||r.call(a)!=A||(b=a.constructor,H(b)&&!(b instanceof b))||!n.argsClass&&z(a)||!n.nodeClass&&ca(a))return false;if(n.ownLast)return B(a,function(a,b,e){c=t.call(e,b);return false}),false!==c;B(a,function(a,b){c=b});return typeof c=="undefined"||t.call(a,c)}function z(a){return a&&typeof a=="object"&&typeof a.length=="number"&&r.call(a)==U||false}function Wa(a,b,c){var d=C(a),f=d.length;for(b=G(b,c,3);f--&&(c=d[f],false!==b(a[c],c,a)););return a}function Xa(a){var b=[];B(a,function(a,d){H(a)&&
b.push(d)});return b.sort()}function H(a){return typeof a=="function"}function y(a){return!(!a||!M[typeof a])}function Ya(a){return typeof a=="number"||a&&typeof a=="object"&&r.call(a)==Q||false}function I(a){return typeof a=="string"||a&&typeof a=="object"&&r.call(a)==K||false}function Aa(a){for(var b=-1,c=C(a),d=c.length,f=Array(d);++b<d;)f[b]=a[c[b]];return f}function Za(a,b,c){var d=-1,f=ua(),e=a?a.length:0,h=false;c=(0>c?Ba(0,e+c):c)||0;s(a)?h=-1<f(a,b,c):typeof e=="number"?h=-1<(I(a)?a.indexOf(b,c):f(a,
b,c)):u(a,function(a){if(++d>=c)return!(h=a===b)});return h}function $a(a,b,c){var d=true;b=e.createCallback(b,c,3);if(s(a)){c=-1;for(var f=a.length;++c<f&&(d=!!b(a[c],c,a)););}else u(a,function(a,c,f){return d=!!b(a,c,f)});return d}function ia(a,b,c){var d=[];b=e.createCallback(b,c,3);if(s(a)){c=-1;for(var f=a.length;++c<f;){var g=a[c];b(g,c,a)&&d.push(g)}}else u(a,function(a,c,f){b(a,c,f)&&d.push(a)});return d}function Ca(a,b,c){b=e.createCallback(b,c,3);if(s(a)){c=-1;for(var d=a.length;++c<d;){var f=
a[c];if(b(f,c,a))return f}}else{var g;u(a,function(a,c,d){if(b(a,c,d))return g=a,false});return g}}function W(a,b,c){if(b&&typeof c=="undefined"&&s(a)){c=-1;for(var d=a.length;++c<d&&false!==b(a[c],c,a););}else u(a,b,c);return a}function ja(a,b,c){var d=a,f=a?a.length:0;b=b&&typeof c=="undefined"?b:G(b,c,3);if(s(a))for(;f--&&false!==b(a[f],f,a););else{if(typeof f!="number")var e=C(a),f=e.length;else n.unindexedChars&&I(a)&&(d=a.split(""));u(a,function(a,c,q){c=e?e[--f]:--f;return b(d[c],c,q)})}return a}function ka(a,
b,c){var d=-1,f=a?a.length:0,g=Array(typeof f=="number"?f:0);b=e.createCallback(b,c,3);if(s(a))for(;++d<f;)g[d]=b(a[d],d,a);else u(a,function(a,c,f){g[++d]=b(a,c,f)});return g}function Da(a,b,c,d){var f=3>arguments.length;b=e.createCallback(b,d,4);if(s(a)){var g=-1,h=a.length;for(f&&(c=a[++g]);++g<h;)c=b(c,a[g],g,a)}else u(a,function(a,d,e){c=f?(f=false,a):b(c,a,d,e)});return c}function ab(a,b,c,d){var f=3>arguments.length;b=e.createCallback(b,d,4);ja(a,function(a,d,e){c=f?(f=false,a):b(c,a,d,e)});return c}
...
Ma=/\bthis\b/,ya="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "),U="[object Arguments]",V="[object Array]",O="[object Boolean]",P="[object Date]",Ta="[object Error]",Q="[object Number]",A="[object Object]",R="[object RegExp]",K="[object String]",E={"[object Function]":false};E[U]=E[V]=E[O]=E[P]=E[Q]=E[A]=E[R]=E[K]=true;var jb={configurable:false,enumerable:false,value:null,writable:false},w={a:"",b:null,c:"",d:"",e:"",v:null,g:"",h:null,support:null,i:"",
j:false},M={"boolean":false,"function":true,object:true,number:false,string:false,undefined:false},Y=M[typeof window]&&window||this,Z=M[typeof global]&&global;!Z||Z.global!==Z&&Z.window!==Z||(Y=Z);var Ea=[],za=Error.prototype,ha=Object.prototype,vb=String.prototype,r=ha.toString,wb=RegExp("^"+String(r).replace(/[.*+?^${}()|[\]\\]/g,"\\$&").replace(/toString| for [^\]]+/g,".*?")+"$"),cb=Math.floor,rb=Function.prototype.toString,$=N($=Object.getPrototypeOf)&&$,t=ha.hasOwnProperty,ea=Ea.push,la=ha.propertyIsEnumerable,
tb=Ea.unshift,kb=function(){try{var a={},b=N(b=Object.defineProperty)&&b,c=b(a,a,a)&&b}catch(d){}return c}(),ga=N(ga=Object.create)&&ga,Fa=N(Fa=Array.isArray)&&Fa,xb=Y.isFinite,yb=Y.isNaN,ma=N(ma=Object.keys)&&ma,Ba=Math.max,zb=Math.min,db=Math.random,F={};F[V]=Array;F[O]=Boolean;F[P]=Date;F["[object Function]"]=Function;F[A]=Object;F[Q]=Number;F[R]=RegExp;F[K]=String;var v={};v[V]=v[P]=v[Q]={constructor:true,toLocaleString:true,toString:true,valueOf:true};v[O]=v[K]={constructor:true,toString:true,valueOf:true};
v[Ta]=v["[object Function]"]=v[R]={constructor:true,toString:true};v[A]={constructor:true};(function(){for(var a=ya.length;a--;){var b=ya[a],c;for(c in v)t.call(v,c)&&!t.call(v[c],b)&&(v[c][b]=false)}})();var n=e.support={};(function(){function a(){this.x=1}var b={0:1,length:1},c=[];a.prototype={valueOf:1,y:1};for(var d in new a)c.push(d);for(d in arguments);n.argsClass=r.call(arguments)==U;n.argsObject=arguments.constructor==Object&&!(arguments instanceof Array);n.enumErrorProps=la.call(za,"message")||la.call(za,
"name");n.enumPrototypes=la.call(a,"prototype");n.funcDecomp=!N(Y.p)&&Ma.test(function(){return this});n.funcNames=typeof Function.name=="string";n.nonEnumArgs=0!=d;n.nonEnumShadows=!/valueOf/.test(c);n.ownLast="x"!=c[0];n.spliceObjects=(Ea.splice.call(b,0,1),!b[0]);n.unindexedChars="xx"!="x"[0]+Object("x")[0];try{n.nodeClass=!(r.call(document)==A&&!({toString:0}+""))}catch(f){n.nodeClass=true}})(1);ga||(ba=function(){function a(){}return function(b){if(y(b)){a.prototype=b;var c=new a;a.prototype=null}return c||Y.Object()}}());
...
b:"typeof u=='number'",v:C,g:"if(e(t[n],n,g)===false)return E"},Ga={a:"z,H,l",i:"var a=arguments,b=0,c=typeof l=='number'?2:a.length;while(++b<c){t=a[b];if(t&&B[typeof t]){",v:C,g:"if(typeof E[n]=='undefined')E[n]=t[n]",c:"}}"},mb={i:"if(!B[typeof t])return E;"+na.i,b:false},u=X(na),fa=X(Ga,{i:Ga.i.replace(";",";if(c>3&&typeof a[c-2]=='function'){var e=d(a[--c-1],a[c--],2)}else if(c>2&&typeof a[c-1]=='function'){e=a[--c]}"),g:"E[n]=e?e(E[n],t[n]):t[n]"}),Ab=X(Ga),B=X(na,mb,{j:false}),L=X(na,mb);H(/x/)&&
(H=function(a){return typeof a=="function"&&"[object Function]"==r.call(a)});var va=$?function(a){if(!a||r.call(a)!=A||!n.argsClass&&z(a))return false;var b=a.valueOf,c=N(b)&&(c=$(b))&&$(c);return c?a==c||$(a)==c:Va(a)}:Va,Bb=wa(function(a,b,c){t.call(a,c)?a[c]++:a[c]=1}),Cb=wa(function(a,b,c){(t.call(a,c)?a[c]:a[c]=[]).push(b)}),Db=wa(function(a,b,c){a[c]=b});e.assign=fa;e.at=function(a){var b=arguments,c=-1,d=S(b,true,false,1),b=b[2]&&b[2][b[1]]===a?1:d.length,f=Array(b);for(n.unindexedChars&&I(a)&&(a=a.split(""));++c<
b;)f[c]=a[d[c]];return f};e.bind=Na;e.countBy=Bb;e.create=function(a,b){var c=ba(a);return b?fa(c,b):c};e.createCallback=function(a,b,c){var d=typeof a;if(null==a||"function"==d)return G(a,b,c);if("object"!=d)return ib(a);var f=C(a),e=f[0],h=a[e];return 1!=f.length||h!==h||y(h)?function(b){for(var c=f.length,d=false;c--&&(d=T(b[f[c]],a[f[c]],null,true)););return d}:function(a){a=a[e];return h===a&&(0!==h||1/h==1/a)}};e.defaults=Ab;e.difference=function(a){return Pa(a,S(arguments,true,true,1))};e.filter=ia;
e.forEach=W;e.forEachRight=ja;e.forIn=B;e.forInRight=function(a,b,c){var d=[];B(a,function(a,b){d.push(b,a)});var f=d.length;for(b=G(b,c,3);f--&&false!==b(d[f--],d[f],a););return a};e.forOwn=L;e.forOwnRight=Wa;e.functions=Xa;e.groupBy=Cb;e.indexBy=Db;e.invert=function(a){for(var b=-1,c=C(a),d=c.length,f={};++b<d;){var e=c[b];f[a[e]]=e}return f};e.invoke=function(a,b){var c=x(arguments,2),d=-1,f=typeof b=="function",e=a?a.length:0,h=Array(typeof e=="number"?e:0);W(a,function(a){h[++d]=(f?b:a[b]).apply(a,
c)});return h};e.keys=C;e.map=ka;e.mapValues=function(a,b,c){var d={};b=e.createCallback(b,c,3);L(a,function(a,c,e){d[c]=b(a,c,e)});return d};e.max=function(a,b,c){var d=-Infinity,f=d;typeof b!="function"&&c&&c[b]===a&&(b=null);if(null==b&&s(a)){c=-1;for(var g=a.length;++c<g;){var h=a[c];h>f&&(f=h)}}else b=null==b&&I(a)?Ja:e.createCallback(b,c,3),u(a,function(a,c,e){c=b(a,c,e);c>d&&(d=c,f=a)});return f};e.merge=function(a){var b=arguments,c=2;if(!y(a))return a;"number"!=typeof b[2]&&(c=b.length);
if(3<c&&"function"==typeof b[c-2])var d=G(b[--c-1],b[c--],2);else 2<c&&"function"==typeof b[c-1]&&(d=b[--c]);for(var b=x(arguments,1,c),e=-1,g=J(),h=J();++e<c;)Ra(a,b[e],d,g,h);D(g);D(h);return a};e.min=function(a,b,c){var d=Infinity,f=d;typeof b!="function"&&c&&c[b]===a&&(b=null);if(null==b&&s(a)){c=-1;for(var g=a.length;++c<g;){var h=a[c];h<f&&(f=h)}}else b=null==b&&I(a)?Ja:e.createCallback(b,c,3),u(a,function(a,c,e){c=b(a,c,e);c<d&&(d=c,f=a)});return f};e.omit=function(a,b,c){var d={};if(typeof b!="function"){var f=[];B(a,function(a,b){f.push(b)});for(var f=Pa(f,S(arguments,true,false,1)),g=-1,h=f.length;++g<h;){var m=f[g];d[m]=a[m]}}else b=e.createCallback(b,c,3),B(a,function(a,c,e){b(a,c,e)||(d[c]=a)});return d};e.pairs=function(a){for(var b=-1,c=C(a),d=c.length,e=Array(d);++b<d;){var g=c[b];e[b]=[g,a[g]]}return e};e.pick=function(a,b,c){var d={};if(typeof b!="function")for(var f=-1,g=S(arguments,true,false,1),h=y(a)?g.length:0;++f<h;){var m=g[f];m in a&&(d[m]=a[m])}else b=e.createCallback(b,c,3),B(a,
function(a,c,e){b(a,c,e)&&(d[c]=a)});return d};e.pluck=ka;e.property=ib;e.reject=function(a,b,c){b=e.createCallback(b,c,3);return ia(a,function(a,c,e){return!b(a,c,e)})};e.shuffle=bb;e.sortBy=function(a,b,c){var d=-1,f=s(b),g=a?a.length:0,h=Array(typeof g=="number"?g:0);f||(b=e.createCallback(b,c,3));W(a,function(a,c,e){var g=h[++d]=oa();f?g.m=ka(b,function(b){return a[b]}):(g.m=J())[0]=b(a,c,e);g.n=d;g.o=a});g=h.length;for(h.sort(ob);g--;)a=h[g],h[g]=a.o,f||D(a.m),da(a);return h};e.toArray=function(a){return a&&
typeof a.length=="number"?n.unindexedChars&&I(a)?a.split(""):x(a):Aa(a)};e.transform=function(a,b,c,d){var f=s(a);if(null==c)if(f)c=[];else{var g=a&&a.constructor;c=ba(g&&g.prototype)}b&&(b=e.createCallback(b,d,4),(f?u:L)(a,function(a,d,e){return b(c,a,d,e)}));return c};e.union=function(){return Sa(S(arguments,true,true))};e.uniq=gb;e.values=Aa;e.where=ia;e.collect=ka;e.each=W;e.eachRight=ja;e.extend=fa;e.methods=Xa;e.select=ia;e.unique=gb;e.clone=function(a,b,c,d){typeof b!="boolean"&&null!=b&&(d=c,
c=b,b=false);return sa(a,b,typeof c=="function"&&G(c,d,1))};e.cloneDeep=function(a,b,c){return sa(a,true,typeof b=="function"&&G(b,c,1))};e.contains=Za;e.every=$a;e.find=Ca;e.findKey=function(a,b,c){var d;b=e.createCallback(b,c,3);L(a,function(a,c,e){if(b(a,c,e))return d=c,false});return d};e.findLast=function(a,b,c){var d;b=e.createCallback(b,c,3);ja(a,function(a,c,e){if(b(a,c,e))return d=a,false});return d};e.findLastKey=function(a,b,c){var d;b=e.createCallback(b,c,3);Wa(a,function(a,c,e){if(b(a,c,e))return d=
c,false});return d};e.has=function(a,b){return a?t.call(a,b):false};e.identity=ta;e.indexOf=Ua;e.isArguments=z;e.isArray=s;e.isBoolean=function(a){return true===a||false===a||a&&typeof a=="object"&&r.call(a)==O||false};e.isDate=function(a){return a&&typeof a=="object"&&r.call(a)==P||false};e.isElement=function(a){return a&&1===a.nodeType||false};e.isEmpty=function(a){var b=true;if(!a)return b;var c=r.call(a),d=a.length;if(c==V||c==K||(n.argsClass?c==U:z(a))||c==A&&typeof d=="number"&&H(a.splice))return!d;L(a,function(){return b=
!1});return b};e.isEqual=function(a,b,c,d){return T(a,b,typeof c=="function"&&G(c,d,2))};e.isFinite=function(a){return xb(a)&&!yb(parseFloat(a))};e.isFunction=H;e.isNaN=function(a){return Ya(a)&&a!=+a};e.isNull=function(a){return null===a};e.isNumber=Ya;e.isObject=y;e.isPlainObject=va;e.isRegExp=function(a){return a&&M[typeof a]&&r.call(a)==R||false};e.isString=I;e.isUndefined=function(a){return typeof a=="undefined"};e.noop=hb;e.reduce=Da;e.reduceRight=ab;e.size=function(a){var b=a?a.length:0;return typeof b=="number"?b:C(a).length};e.some=eb;e.sortedIndex=fb;e.all=$a;e.any=eb;e.detect=Ca;e.findWhere=Ca;e.foldl=Da;e.foldr=ab;e.include=Za;e.inject=Da;e.sample=function(a,b,c){a&&typeof a.length!="number"?a=Aa(a):n.unindexedChars&&I(a)&&(a=a.split(""));if(null==b||c)return a?a[0+cb(db()*(a.length-1-0+1))]:void 0;a=bb(a);a.length=zb(Ba(0,b),a.length);return a};e.VERSION="2.4.1";Y._=e}.call(this));
